...
- Regression coverage and a bugfix report for MCP initialize handshakes (T-1778), covering missing/non-object params, absent required fields, wrong field types, malformed client implementation information, and supported/unsupported protocol-version negotiation.
