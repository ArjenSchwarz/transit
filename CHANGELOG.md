...
- Added deterministic regression coverage for project color hex round-trip boundaries, RGB format, and opacity handling (T-1807). The implementation fix is pending in the next checkpoint.
