...
- T-2036: Added regression coverage for empty `completionDate` and `lastStatusChangeDate` objects, including the combined no-op case; the implementation fix is pending.
