...
### Fixed
- T-1799: Added regression coverage for strict absolute date-filter validation, including leap-year, calendar-boundary, non-ASCII, non-padded, and QueryTasksIntent cases. The implementation is pending in the follow-up fix commit.
