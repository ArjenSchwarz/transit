...
### Changed
- T-1620: Added deterministic terminal-report fetch seams and regression coverage that distinguishes task and milestone storage failures from a valid empty report before correcting the intent response.
