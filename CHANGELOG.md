...
- T-1819: Added regression coverage for reversed absolute `completionDate` and `lastStatusChangeDate` ranges across the shared parser, QueryTasksIntent, and visual FindTasksIntent. The implementation is pending in the follow-up fix commit.
