...
- Deterministic gated task and milestone regressions now cover peer display-ID changes that land while duplicate cleanup is suspended in asynchronous allocation (T-2019), including the task path's false-audit-comment failure mode.
