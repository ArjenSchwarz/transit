...
- T-1765 cancellation regression coverage for pre-cancelled uncontended task/milestone creates and cancellation during successful non-cooperative display-ID allocation, plus a systematic bugfix report documenting the persistence race.
