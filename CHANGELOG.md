...
- T-1821: Added regression coverage for MCP Settings port commits that occur on focus loss rather than Return, including coalescing/disabled-state presentation contracts and a live loopback listener replacement test. The implementation will route committed values through the existing lifecycle coordinator.
