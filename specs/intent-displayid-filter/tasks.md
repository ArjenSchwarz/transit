...
- [x] 1. Add displayId field to QueryFilters and update @Parameter description
...
- [x] 2. Add displayId lookup path in execute() with direct FetchDescriptor
...
- [x] 3. Extend taskToDict with detailed parameter for description and metadata
...
- [x] 4. Test displayId lookup returns task with description and metadata
...
- [x] 6. Test displayId with non-matching filter returns empty array
...
- [x] 7. Verify existing QueryTasksIntent tests still pass
