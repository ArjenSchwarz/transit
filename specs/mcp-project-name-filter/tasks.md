...
- [x] 1. Add `project` parameter to `queryTasks` tool schema <!-- id:2knsk02 -->
...
- [x] 2. Resolve project name in `handleQueryTasks` <!-- id:2knsk03 -->
...
- [x] 3. Add unit tests for project name filter <!-- id:2knsk04 -->
...
- [x] 4. Verify build and lint <!-- id:2knsk05 -->
