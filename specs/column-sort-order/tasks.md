...
- [x] 1. ColumnSortOrder enum and buildFilteredColumns sort parameter <!-- id:1ouojhd -->
...
- [x] 2. Organized sort mode produces correct task ordering <!-- id:1ouojhe -->
...
- [x] 3. Sort toggle button in dashboard toolbar <!-- id:1ouojhf -->
...
- [x] 4. Sort toggle integrates correctly with filters and column views <!-- id:1ouojhg -->
