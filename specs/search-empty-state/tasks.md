...
- [ ] 1. Empty-state selection logic chooses the correct state for every filter combination <!-- id:2q7l19f -->
...
- [ ] 2. Unit tests verify empty-state selection precedence across all cases <!-- id:2q7l19g -->
...
- [ ] 3. Dashboard shows the search empty state and keeps the search bar visible <!-- id:2q7l19h -->
...
- [ ] 4. UI test confirms search empty state appears and search field persists <!-- id:2q7l19i -->
