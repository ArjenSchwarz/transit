...
- [x] 1. Cmd+N opens Add Task sheet on iOS/iPadOS via `.keyboardShortcut` on the existing toolbar button
...
- [x] 2. FocusedValueKey wiring exposes `showAddTask` binding to the scene level <!-- id:0mr895z -->
...
- [x] 3. macOS File menu shows "New Task" (Cmd+N) via CommandGroup replacing .newItem <!-- id:0mr8960 -->
...
- [x] 4. Bare "t" key opens Add Task sheet when dashboard has focus and no sheet is presented <!-- id:0mr8961 -->
...
- [x] 5. Unit tests verify shortcut guard conditions <!-- id:0mr8962 -->
...
- [x] 6. Build succeeds on both iOS and macOS targets with no warnings
