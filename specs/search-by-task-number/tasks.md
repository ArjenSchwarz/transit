---
references:
    - specs/search-by-task-number/smolspec.md
---
# Search by Task Number

- [x] 1. Display ID matching added to dashboard search filter <!-- id:g41r7iy -->

- [x] 2. Search by full formatted display ID ("T-42") returns the matching task <!-- id:g41r7iz -->
  - Blocked-by: g41r7iy (Display ID matching added to dashboard search filter)

- [x] 3. Search by bare number ("42") returns the matching task <!-- id:g41r7j0 -->
  - Blocked-by: g41r7iy (Display ID matching added to dashboard search filter)

- [x] 4. Display ID search combines correctly with project, type, and milestone filters <!-- id:g41r7j1 -->
  - Blocked-by: g41r7iy (Display ID matching added to dashboard search filter)
