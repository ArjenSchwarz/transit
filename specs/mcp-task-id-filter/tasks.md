...
- [ ] 1. Add displayId parameter to query_tasks tool schema and update tool description
...
- [ ] 2. displayId lookup returns matching task with description and metadata
...
- [ ] 3. displayId filter composes with other filters
