...
- [x] 1. Static quick action defined in Info.plist <!-- id:6yfh7qs -->
...
- [x] 2. QuickActionService communicates pending actions to views <!-- id:6yfh7qt -->
...
- [x] 3. AppDelegate handles quick actions on warm and cold start <!-- id:6yfh7qu -->
...
- [x] 4. DashboardView presents AddTaskSheet on quick action <!-- id:6yfh7qv -->
