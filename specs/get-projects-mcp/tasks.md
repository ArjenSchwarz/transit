...
- [ ] 1. Add `getProjects` tool definition <!-- id:9yxyrpn -->
...
- [ ] 2. Implement `handleGetProjects` handler <!-- id:9yxyrpo -->
...
- [ ] 3. Update tools/list test for 5 tools <!-- id:9yxyrpp -->
...
- [ ] 4. Test: projects returned with correct fields and sort order <!-- id:9yxyrpq -->
...
- [ ] 5. Test: empty array when no projects exist <!-- id:9yxyrpr -->
  - Call `get_projects` with no projects in the context. Verify the response is an empty JSON array.
  - Blocked-by: 9yxyrpo (Implement `handleGetProjects` handler)

- [ ] 6. Test: activeTaskCount excludes terminal tasks <!-- id:9yxyrps -->
...
- [ ] 7. Verify tests and lint pass <!-- id:9yxyrpt -->
