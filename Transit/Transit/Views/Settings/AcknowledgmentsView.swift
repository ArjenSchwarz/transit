...
/// A dependency listed in the acknowledgments screen.
/// Update this list when Package.resolved changes.
    ...
    private var iOSLayout: some View {
        List {
            Section {
                ...
                Text("All packages are licensed under the Apache License 2.0.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }

            Section {
                NavigationLink(value: NavigationDestination.licenseText) {
    ...
    private var macOSLayout: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                ...
                LiquidGlassSection(title: "License") {
                    VStack(alignment: .leading, spacing: 12) {
                        Text("All packages are licensed under the Apache License 2.0.")
                            .foregroundStyle(.secondary)
                        NavigationLink(value: NavigationDestination.licenseText) {
                            Text("View Full License Text")
                        }
                        .buttonStyle(.plain)
                    }
                }
