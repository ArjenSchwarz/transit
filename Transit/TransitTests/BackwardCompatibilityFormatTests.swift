...
/// Verifies existing intent names and JSON response formats remain unchanged.
/// Adapted from V1's format stability tests.
...
struct BackwardCompatibilityFormatTests {
    ...
    // MARK: - Existing Intent Names Unchanged
    ...
    // MARK: - JSON Input/Output Formats Unchanged
