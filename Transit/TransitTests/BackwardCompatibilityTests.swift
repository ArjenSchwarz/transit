...
/// Shortcuts-friendly visual intents. [Task 15]
...
struct BackwardCompatibilityTests {
    ...
    // MARK: - 15.1: QueryTasksIntent Without Date Filters
    ...
    @Test func queryWithEmptyStringReturnsResults() throws {
        ...
        // Should include at least our 2 tasks (shared store may have more)
    ...
    @Test func queryWithStatusFilterStillWorks() throws {
        ...
        // Use projectId + status to isolate
        let result = QueryTasksIntent.execute(
    ...
    // MARK: - 15.2: CreateTaskIntent With Current JSON Format
    ...
    // MARK: - 15.3: UpdateStatusIntent Unchanged
